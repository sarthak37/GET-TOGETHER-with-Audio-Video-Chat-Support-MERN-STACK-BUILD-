...
const Menu = (props) => (
    ...
    >
        <a className="navbar-brand" style={{ color: "red", fontFamily: 'Courgette, cursive' }} href="/">
            <i className="fas fa-camera-retro mr-2"></i>GET TOGETHER
        </a>
        <a className="navbar-brand" style={{ color: "green", fontFamily: 'Courgette, cursive' }} href="/">
            <i className="fas fa-grin-beam mr-2"></i>SARTHAK(MERN STACK DEVELOPER)
        </a>
